  ...
  return (
    <div className="min-h-screen geometric-bg islamic-pattern flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        <h1 className="font-arabic text-3xl text-gold mb-1">رمضان فيث</h1>
        <p className="text-sm text-muted-foreground">RAMADAN FAITH – Build Your Akhirah</p>
        <p className="text-xs text-muted-foreground mt-1">🇪🇹 Ethiopia's Islamic Productivity Platform</p>
      </motion.div>
